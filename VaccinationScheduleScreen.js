    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.modalBackdrop}>
        ...
        <View style={styles.modalCard}>
          ...
          <View style={styles.enableRow}><View><Text style={styles.enableTitle}>Enabled</Text><Text style={styles.enableDetail}>Apply this entry to new brooding batches</Text></View><Switch value={enabled} onValueChange={setEnabled} trackColor={{ false: '#34434a', true: '#8e4a0c' }} thumbColor={enabled ? ORANGE : '#9aa5a8'} /></View>
  ...
  return (
    <View style={[styles.scheduleRow, index < total - 1 && styles.scheduleRowDivider, !item.enabled && styles.vaccineDisabled]}>
      ...
      <View style={styles.vaccineCopy}>
        <View style={styles.vaccineTop}><View style={styles.vaccineTitleCopy}><Text style={styles.vaccineName}>{item.name}</Text><Text style={styles.vaccineState}>{item.enabled ? 'Included in farm schedule' : 'Disabled'}</Text></View><Switch value={item.enabled} onValueChange={onToggle} trackColor={{ false: '#34434a', true: '#8e4a0c' }} thumbColor={item.enabled ? ORANGE : '#9aa5a8'} /></View>
